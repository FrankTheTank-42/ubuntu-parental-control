...
assert.ok(optionsHtml.includes('id="default-rule"'));
assert.ok(optionsHtml.includes('Alles erlauben (Standard)'));
assert.ok(optionsHtml.includes('Alles blockieren'));
...
assert.ok(optionsHtml.includes('class="domain-section"'));
assert.ok(optionsHtml.includes('show-domain-add'));
assert.ok(optionsHtml.includes('domain-add-panel'));
assert.ok(!optionsHtml.includes('admin-domains'));
...
assert.ok(optionsSource.includes('function stageOpenDomainPanel()'));
assert.ok(optionsSource.includes('className = "remove-base-domain"'));
assert.ok(!optionsSource.includes('admin-domains'));
